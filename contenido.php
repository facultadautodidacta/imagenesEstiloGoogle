<?php 
	...
	function contenido(){
		...
		$datos[0]="img/manticora.jpg"."||".
				  "Mantícora"."||".
				  "La mantícora es una legendaria criatura persa similar a la esfinge egipcia. Tiene el cuerpo de un león, una cabeza humana con tres filas de dientes afilados y a veces alas de murciélago. Otros aspectos de la criatura varían de una historia a otra.";
...
";
		...
		$datos[3]="img/grifo.jpg"."||".
				  "Grifo"."||".
				  "El grifo es una criatura mitológica, cuya parte superior es la de un águila gigante, con plumas doradas, afilado pico y poderosas garras. La parte inferior es la de un león, con pelaje amarillo, musculosas patas y cola larga.";
